...
- **Unit:** 1 interaction = 2–5-turn (varying) conversation + memory-write (17.9 model calls avg), averaged over **80 interactions**. Deployed on Vertex AI Agent Engine (GEAP).
...
| Memory Bank — generation | tokens | 2797 | — | — |
...
| **Total (measured SKUs)** | **0.0742** (range 0.0236–2.1228) |
