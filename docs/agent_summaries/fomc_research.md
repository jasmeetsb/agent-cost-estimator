...
- **Unit:** 1 interaction = a 2-turn conversation in a single session, followed by a memory-write step (4.7 model calls on average). All numbers below are averaged over **80 interactions**. Deployed on Vertex AI Agent Engine.
...
| Gemini tokens — coordinator agent (input) | tokens | 13067 | — | — |
| Gemini tokens — coordinator agent (output) | tokens | 353 | — | — |
| Gemini tokens — sub-agents (input) | tokens | 14260 | — | — |
| Gemini tokens — sub-agents (output) | tokens | 1750 | — | — |
...
| Google Search grounding | grounded query-turns | 0.66 | — | — |
...
| Firestore (15 writes / 53 reads over 80 interactions) | 0.0000001 |
| Vertex AI Search (RAG: 0.65 queries/interaction @ $1.50/1K) | 0.000975 |
| Google Search grounding (0.66 grounded query-turns/interaction @ $14/1K) | 0.009275 |
| Memory Bank retrieval (0.07 memories retrieved/interaction @ $0.5/1K) | 0.000037 |
